...
function App() {
  ...
  useEffect(() => {
    api
      ...
      .then((res) => {
        ...
        // 전체 페이지 할당
        setTotalPaages(res.data.totalPages);
      })
      .catch((err) => {
        console.log(err);
      });
  ...
  return (
    <div className="container py-5">
      ...
      <p className="text-secondary">Spring Boot + React + JPA Sample Project</p>
      ...
      <div className="d-flex justify-content-center mt-4">
        <Pagination>
          ...
          <Pagination.Next 
            ...
            onClick={() => {
              if(page < totalPages -1) setPage(page)
            }}
          />
          <Pagination.Last
            disabled = {page == (totalPages - 1 )}
